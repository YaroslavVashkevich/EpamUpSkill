...
import com.epam.upskil.main.content.Gift;
import com.epam.upskil.main.content.GiftPackaging;
import com.epam.upskil.main.content.Sweetness;
    ...
    public CreateGift() {
        ...
        while (true) {
            ...
            switch (new Scanner(System.in).nextInt()) {
                ...
                case 1:
                    Sweetness sweetnes = addSweetness();
                    while (sweetnes == null) {
